...
water_vaporization_heat=2264705 #J/kg
...
def update_cloud_model(theta,Qv,Qc,Qr,pbar,timeStep):
    ...
    dtheta=-water_vaporization_heat/air_heat_capacity_isobaric*(dQce+dQre)/pai
...
def show_buoyancy_analysis(heights,T0,RH0,Tbar,pbar):
    ...
    T=T+dQc*water_vaporization_heat/air_heat_capacity_isobaric
